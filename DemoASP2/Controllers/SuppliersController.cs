...
namespace DemoASP2.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SupplierId,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phon,Fax,HomePage")] Supplier supplier)
        {
